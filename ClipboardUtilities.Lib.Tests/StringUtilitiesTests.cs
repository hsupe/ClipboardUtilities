...
public class StringUtilitiesTests
{
	...
	[Fact]
	public void FormatXml_GivenInvalidXml_ReturnsError()
	{
		_sut.FormatXml("<Project").Should().Contain("System.Xml.XmlException");
	}
	...
	{
		Test(new List<string> { "256.256.256.256" },
			new List<string> { "Invalid: [256.256.256.256]. An invalid IP address was specified." },
	...
	{
		_sut.LogDateToSplunkDate("2015-01-20  16:47:32.777").Should().Be("\"01/20/2015:16:47:32\"");
	}
	...
	{
		_sut.ConvertPathFromWindowsToWsl(@"C:\Program Files\SomeFile.exe").Should()
			.Be(@"/mnt/c/Program\ Files/SomeFile.exe");
	}
